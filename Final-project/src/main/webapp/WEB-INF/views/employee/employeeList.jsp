        ...
        <main>
            <div id="main">
                ...
                <c:forEach var="employee" items="${employeeList }">
                    ...
                    <tr height = "40" style="border-top: 1px solid #ddd;">
                        <td><a href="employeeView.do?employeeNumber=${employee.employeeNumber}">${employee.employeeNumber}</a></td>
                        ...
                        <td>${employee.employeeRegDate}</td>
                        <td>${employee.employeeLogDate}</td>
                        <td>${employee.roleCode}</td>
                                
                        
                        <td><a href="employeeDelete.do?employeeNumber=${employee.employeeNumber}">삭제</a></td>
                    ...
                    <tr>
                        <td><a href="employeeInsert.do">등록</a></td>
                    </tr>
                </table>
        </div>
        </main>
